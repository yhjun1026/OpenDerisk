...
export default function PermissionDefinitions({ roles: externalRoles }: PermissionDefinitionsProps) {
  ...
  const handleCreate = async () => {
    try {
      ...
      // If multiple resources selected, create multiple permission definitions
  ...
  const handleEdit = async () => {
    ...
    try {
      ...
      // Handle multi-select: convert array to string or use first value
  ...
  return (
    <div className="p-4">
      <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
        <Space>
          ...
          <Text strong className="text-lg">
            {t('permissions_definition_management')}
          </Text>
        </Space>
      ...
      <Alert
        ...
        showIcon
        className="mb-4"
        message={t('permissions_definition_hint')}
        description={
          <Text type="secondary">
            {t('permissions_definition_description')}
          </Text>
        }
      />
